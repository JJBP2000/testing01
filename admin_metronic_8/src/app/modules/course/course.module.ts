...
@NgModule({
  declarations: [
    ...
    CourseListsComponent, SectionAddComponent, SectionEditComponent, SectionDeleteComponent, ClaseAddComponent, ClaseEditComponent, ClaseDeleteComponent, ClaseFileDeleteComponent,
  ],
  imports: [
    CommonModule,
    CourseRoutingModule,
