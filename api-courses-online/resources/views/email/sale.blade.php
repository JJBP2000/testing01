																	...
																	<table width="100%" border="0" cellspacing="0" cellpadding="0">
																		<tr>
																			<td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
																				<a href="#" target="_blank"><img src="courses-online\src\assets\images\logo\logo.png" width="112" height="43" editable="true" border="0" alt="" /></a>
																			</td>
																		</tr>
																	</table>
																	<!-- Logo -->
																							...
																							<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <th class="column-top" valign="top" width="230" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
                                                                                                                        <div class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;"><a href="#" target="_blank">
																															<img src="{{ env("APP_URL")."storage/".$sale_detail->course->imagen }}" border="0" width="230" height="180" editable="true" alt="" /></a></div>
                                                                                                                    </th>
                                                                                                                    <th class="column-top mpb-15" valign="top" width="30" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;"></th>
																								...
																								<tr>
																									<td class="text-16 lh-26 a-center pb-25" style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center; padding-bottom: 25px;">
																										<multiline>
																											<em>Gracias por hacer la compra de los cursos que acompañaran tu éxito. </em>
																										</multiline>
																									</td>
																								</tr>
																								<tr>
																...
																<tr>
																	<td class="text-14 lh-24 a-center c-white l-white pb-20" style="font-size:14px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 24px; text-align:center; color:#ffffff; padding-bottom: 20px;">
																		<multiline>
																			Guatemala, Guatemala
																			<br />
																			<a cm_dontconvertlink href="tel:+502 41949127" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">+502 41949127</span></a> - <a cm_dontconvertlink href="tel:+502 41949127" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">+502 41949127</span></a>
																			<br />
																			<a href="mailto:histu@gmail.com" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;"></span></a> - <a href="www.website.com" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">www.website.com</span></a>
																		</multiline>
																	</td>
																</tr>
																<tr>
