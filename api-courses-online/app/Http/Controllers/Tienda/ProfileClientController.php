...
class ProfileClientController extends Controller
{
        ...
        return response()->json([
            ...
            "enrolled_courses" => $enrolled_courses->map(function($course_student){
                return [
                    ...
                    "percentage" => $this->calculatePercentage($course_student),
    ...
    private function calculatePercentage($course_student) {
        if (is_null($course_student->clases_checkeds) || $course_student->course->count_class == 0) {
            return 0;
        }
        $clases_checkeds = explode(",", $course_student->clases_checkeds);
        return round((sizeof($clases_checkeds) / $course_student->course->count_class) * 100, 2);
    }
