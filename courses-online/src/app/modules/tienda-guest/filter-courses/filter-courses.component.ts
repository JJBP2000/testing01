...
export class FilterCoursesComponent {
  ...
  clearFiltersAndRefresh() {
    // Restablece todas las variables de filtro a sus valores por defecto
    ...
    // Restablece el control de calificación
    document.querySelectorAll('.rating-star-selected').forEach(star => {
        star.classList.remove('rating-star-selected'); // Asumiendo que 'rating-star-selected' es la clase que resalta las estrellas
    });
